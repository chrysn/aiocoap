...
::
    ...
    $ pip3 install --upgrade --process-dependency-links "aiocoap[all]"
...
::
    ...
    $ pip3 install --upgrade --process-dependency-links ".[all,docs]"
...
from the web::
    ...
    $ pip3 install --upgrade --process-dependency-links "git+https://github.com/chrysn/aiocoap#egg=aiocoap[all]"
