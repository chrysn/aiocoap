...
::
    ...
    $ pip3 install --upgrade "aiocoap[linkheader,docs]"
...
::
    ...
    $ pip3 install --upgrade ".[linkheader,docs]"
...
from the web::
    ...
    $ pip3 install --upgrade "git+https://github.com/chrysn/aiocoap#egg=aiocoap[linkheader,docs]"
